...
function handleClick (value) {
  setCurrent(value);
  value === 'bun' ? bun.current.scrollIntoView() 
  : value === 'sauce' ? sauce.current.scrollIntoView() 
  ...
  return (
    <section className={`${styles.ingredients__section} pl-4 pr-5 pt-10 pb-8`}>
      ...
      <div className={styles.ingredients__menu}>
        ...
        <IngredientList ref = {sauce} title="Соусы" ingredient="sauce" data={props} />
        <IngredientList ref = {main} title="Начинки" ingredient="main" data={props} />
      </div>
    </section>
  );
}
